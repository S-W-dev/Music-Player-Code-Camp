document.addEventListener('DOMContentLoaded', function(){
	...
	Start_Ludicrous.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"ludicrous"}, function(response) {});
	});

	Start_Hydra.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"hydra"}, function(response) {});
	});

	Start_Muffin.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"muffin"}, function(response) {});
	});

	Start_BetterNow.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"BetterNow"}, function(response) {});
	});

	Start_Thunder.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"Thunder"}, function(response) {});
	});;

	Start_Bob.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"Bob"}, function(response) {});
	});

	Start_Mine.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"Mine"}, function(response) {});
	});

	Start_Sorry.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"Sorry"}, function(response) {});
	});

	Start_Megalovania.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"Megalovania"}, function(response) {});
	});

	Start_Lemon.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"lemon_tree"}, function(response) {});
	});
	Start_Mech.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"quantom_mechanic"}, function(response) {});
	});
	Start_Hotel.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"hotel_california"}, function(response) {});
	});
	Start_Bohemian.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"bohemian_rhapsody"}, function(response) {});
	});
	Start_Pain.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"painkiller"}, function(response) {});
	});
	Start_Jingle.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"jingle_bell_rock"}, function(response) {});
	});
	Start_Holy.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"o_holy_night"}, function(response) {});
	});
	Start_Black.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"back_in_black"}, function(response) {});
	});
	Start_Christmas.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"merry_little_christmas"}, function(response) {});
	});
	Start_Yellow.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"yellow_ledbetter"}, function(response) {});
	});
	Start_Fun.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"life_is_fun"}, function(response) {});
	});
	Start_Usa.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"god_bless_usa"}, function(response) {});
	});
	Start_Gun.addEventListener('click', function() {window.location.href = 'popup.html';
		chrome.runtime.sendMessage({type: "Start", value:"elephant_gun"}, function(response) {});
	});
	Start_Despacito.addEventListener('click', function() {window.location.href = 'popup.html';
